...
class MambaConfig:
    ...
    def __post_init__(self):
        self.d_inner = self.expand * self.n_embd # E*D = ED in comments
        ...
        # muP
        if self.mup:
            self.mup_width_mult = self.n_embd / self.mup_base_width
...
class ResidualBlock(nn.Module):
    def __init__(self, config: MambaConfig):
        ...
        self.norm = RMSNorm(config.n_embd, config.rms_norm_eps, config.mup)
